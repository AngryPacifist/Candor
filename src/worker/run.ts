...
export interface BootHooks {
  /** flip the bootstrap health endpoint to live, with a detail provider */
  live: (detail: () => Record<string, unknown>) => void;
}

export async function start(hooks: BootHooks): Promise<void> {
